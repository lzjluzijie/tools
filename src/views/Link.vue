  ...
  <div id="link" class="columns">
    <div class="column is-6">
      ...
      <div class="content control">
        <p
          id="directURL"
          class="content clipboard"
          v-bind:data-clipboard-text="directURL"
    ...
    <div class="column is-6">
      ...
      <div class="content control">
        <p
          id="shortURL"
          class="content clipboard"
          v-bind:data-clipboard-text="shortURL"
          style="word-wrap:break-word"
        >
          Short URL: {{ shortURL }}
        </p>
...
export default {
  ...
  computed: {
    directURL: function() {
      ...
      //SharePoint
      if (
        host.slice(-14) === "sharepoint.com" ||
        host.slice(-13) === "sharepoint.cn"
      ) {
        const i = sharingURL.indexOf(":/g");
        sharingURL =
          sharingURL.substring(0, i - 3) + sharingURL.substring(i + 3);
        return (
          sharingURL.substring(0, sharingURL.lastIndexOf("/")) +
          "/_layouts/15/download.aspx?share=" +
          sharingURL.substring(sharingURL.lastIndexOf("/") + 1).split("?")[0]
        );
      }
      //OneDrive
  ...
  methods: {
    ...
    getWeiboShortURL: function() {
      ...
      const url = `https://api.weibo.com/2/short_url/shorten.json?source=569452181&url_long=${encodeURIComponent(
        longURL
