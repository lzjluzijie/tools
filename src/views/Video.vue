  ...
  <div>
    <div class="columns">
      ...
      <div class="column is-6">
        ...
        <div v-if="id">
          <h3 class="title is-3">
            <a v-bind:href="url" target="_blank"> Youtube : {{ title }} </a>
          </h3>
          <h4 class="title is-4">
            Length : {{ new Date(1000 * length).toISOString().substr(11, 8) }}
          </h4>
          <vue-good-table
            :columns="columns"
          ...
          >
            <template slot="table-row" slot-scope="props">
              <span v-if="props.column.field === 'url'">
                <button
                  class="clipboard button is-primary is-fullwidth"
                  v-bind:data-clipboard-text="props.row[props.column.field]"
                >
